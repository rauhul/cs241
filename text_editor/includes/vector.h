 ...
 *
 * Also note that index could be well beyond the position of the last entry,
 * in which case the vector should resize() to accommodate that new entry.
*/
 ...
 *
 * If the index is not the last element of the vector,
 * you should also shift all subsequent entries down.
 *
